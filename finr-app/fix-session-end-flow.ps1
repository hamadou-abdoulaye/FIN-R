# FIN-R - Correctif final : fin de session ingenieur (plus de ses1)
Write-Host "Application du correctif fin de session..." -ForegroundColor Cyan
...
'@
[System.IO.File]::WriteAllText((Join-Path $PWD "src\pages\SessionCompleted.tsx"), $file0)
...
'@
[System.IO.File]::WriteAllText((Join-Path $PWD "src\components\layout\ProtectedRoute.tsx"), $file2)
...
'@
[System.IO.File]::WriteAllText((Join-Path $PWD "src\pages\Login.tsx"), $file3)
...
'@
[System.IO.File]::WriteAllText((Join-Path $PWD "src\App.tsx"), $file4)
Write-Host "  OK  src/App.tsx"

Write-Host ""
Write-Host "Correctif applique. Le serveur React va recharger automatiquement." -ForegroundColor Green