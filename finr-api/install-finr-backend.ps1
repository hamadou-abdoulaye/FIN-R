# FIN-R - Script d'installation des fichiers backend
# Lancer depuis le dossier finr-api avec PowerShell
...
'@
Set-Content -Path "app\Models\User.php" -Value $content_7 -Encoding UTF8
...
'@
Set-Content -Path "app\Models\Engineer.php" -Value $content_14 -Encoding UTF8
...
'@
Set-Content -Path "app\Models\Session.php" -Value $content_21 -Encoding UTF8
...
'@
Set-Content -Path "app\Models\SessionEvent.php" -Value $content_28 -Encoding UTF8
...
'@
Set-Content -Path "app\Models\ReasoningScore.php" -Value $content_35 -Encoding UTF8
...
'@
Set-Content -Path "app\Http\Controllers\AuthController.php" -Value $content_42 -Encoding UTF8
...
'@
Set-Content -Path "app\Http\Controllers\EngineerController.php" -Value $content_49 -Encoding UTF8
...
'@
Set-Content -Path "app\Http\Controllers\SessionController.php" -Value $content_56 -Encoding UTF8
...
'@
Set-Content -Path "app\Http\Middleware\JwtMiddleware.php" -Value $content_63 -Encoding UTF8
...
'@
Set-Content -Path "app\Services\NlpService.php" -Value $content_70 -Encoding UTF8
...
'@
Set-Content -Path "app\Events\SessionUpdated.php" -Value $content_77 -Encoding UTF8
...
'@
Set-Content -Path "bootstrap\app.php" -Value $content_84 -Encoding UTF8
...
'@
Set-Content -Path "config\cors.php" -Value $content_91 -Encoding UTF8
...
'@
Set-Content -Path "database\migrations\2024_01_01_000001_create_finr_tables.php" -Value $content_98 -Encoding UTF8
...
'@
Set-Content -Path "database\seeders\DatabaseSeeder.php" -Value $content_105 -Encoding UTF8
...
'@
Set-Content -Path "routes\api.php" -Value $content_112 -Encoding UTF8
