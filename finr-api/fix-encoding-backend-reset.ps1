# FIN-R - RESET COMPLET BACKEND avec encodage UTF-8 force (sans BOM)
$ErrorActionPreference = "Stop"
Write-Host "Reinstallation complete du backend en UTF-8..." -ForegroundColor Cyan
...
'@
[System.IO.File]::WriteAllText((Join-Path $PWD "app\Models\User.php"), $file0, $Utf8NoBom)
...
'@
[System.IO.File]::WriteAllText((Join-Path $PWD "app\Models\Engineer.php"), $file1, $Utf8NoBom)
...
'@
[System.IO.File]::WriteAllText((Join-Path $PWD "app\Models\Session.php"), $file2, $Utf8NoBom)
...
'@
[System.IO.File]::WriteAllText((Join-Path $PWD "app\Models\SessionEvent.php"), $file3, $Utf8NoBom)
...
'@
[System.IO.File]::WriteAllText((Join-Path $PWD "app\Models\ReasoningScore.php"), $file4, $Utf8NoBom)
...
'@
[System.IO.File]::WriteAllText((Join-Path $PWD "app\Http\Controllers\AuthController.php"), $file5, $Utf8NoBom)
...
'@
[System.IO.File]::WriteAllText((Join-Path $PWD "app\Http\Controllers\EngineerController.php"), $file6, $Utf8NoBom)
...
'@
[System.IO.File]::WriteAllText((Join-Path $PWD "app\Http\Controllers\SessionController.php"), $file7, $Utf8NoBom)
...
'@
[System.IO.File]::WriteAllText((Join-Path $PWD "app\Http\Middleware\JwtMiddleware.php"), $file8, $Utf8NoBom)
...
'@
[System.IO.File]::WriteAllText((Join-Path $PWD "app\Services\NlpService.php"), $file9, $Utf8NoBom)
...
'@
[System.IO.File]::WriteAllText((Join-Path $PWD "app\Events\SessionUpdated.php"), $file10, $Utf8NoBom)
...
'@
[System.IO.File]::WriteAllText((Join-Path $PWD "bootstrap\app.php"), $file11, $Utf8NoBom)
...
'@
[System.IO.File]::WriteAllText((Join-Path $PWD "config\cors.php"), $file12, $Utf8NoBom)
...
'@
[System.IO.File]::WriteAllText((Join-Path $PWD "database\migrations\2024_01_01_000001_create_finr_tables.php"), $file13, $Utf8NoBom)
...
'@
[System.IO.File]::WriteAllText((Join-Path $PWD "database\seeders\DatabaseSeeder.php"), $file14, $Utf8NoBom)
...
'@
[System.IO.File]::WriteAllText((Join-Path $PWD "routes\api.php"), $file15, $Utf8NoBom)
Write-Host "  OK  routes/api.php"

Write-Host ""
Write-Host "Reinstallation terminee : 16 fichiers regeneres en UTF-8 propre." -ForegroundColor Green
Write-Host "Lancez ensuite: php artisan route:clear" -ForegroundColor Yellow